...
#Generating Plot 1
  plot(hpc_subset$timestamp,hpc_subset$Global_active_power, type="l", xlab="", ylab="Global Active Power")
        
#Generating Plot 2
  plot(hpc_subset$timestamp,hpc_subset$Voltage, type="l", xlab="datetime", ylab="Voltage")
        
#Generating Plot 3
  plot(hpc_subset$timestamp,hpc_subset$Sub_metering_1, type="l", xlab="", ylab="Energy sub metering")
  lines(hpc_subset$timestamp,hpc_subset$Sub_metering_2,col="red")
  lines(hpc_subset$timestamp,hpc_subset$Sub_metering_3,col="blue")
  legend("topright", col=c("black","red","blue"), c("Sub_metering_1  ","Sub_metering_2  ", "Sub_metering_3  "),lty=c(1,1), bty="n", cex=.5) #bty removes the box, cex shrinks the text, spacing added after labels so it renders correctly
  
  #Generating Plot 4
  plot(hpc_subset$timestamp,hpc_subset$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
        
#OUTPUT
  dev.copy(png, file="Files/plot4.png", width=480, height=480)
  dev.off()
